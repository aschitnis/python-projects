...
# Quick Tutorial on python REST- queries: https://www.pluralsight.com/guides/web-scraping-with-request-python
...
def GetOrtWetterdaten(city):
 ...
 dictWetterdatenfuerOrt["land"]     = jsonRes['sys']['country']		# Abkürzung z.b. 'AT' für Österreich 
